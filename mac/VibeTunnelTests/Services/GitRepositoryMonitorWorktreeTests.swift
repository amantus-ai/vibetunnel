...
struct GitRepositoryMonitorWorktreeTests {
    ...
    func testGitRepositoryInfoResponseWorktreeField() {
    ...
    func testGitRepositoryInfoResponseMissingWorktreeField() {
        ...
        let decoder = JSONDecoder()
        let response = try? decoder.decode(GitRepositoryInfoResponse.self, from: jsonWithoutWorktree.data(using: .utf8)!)
    ...
    func testRegularRepositoryDetection() async {
    ...
    func testWorktreeRepositoryDetection() async {
    ...
    func testWorktreeStatusFallback() {
    ...
    func testGitRepositoryModelWorktreeStatus() {
    ...
    func testCachePreservesWorktreeStatus() async {
        // Clear cache first
        monitor.clearCache()
    ...
    func testRepositoryStatusUpdatePreservesWorktree() {
    ...
    func testWorktreeDetectionDeepPaths() {
    ...
    func testRemoteResponseWorktreeGitHub() {
...
struct GitRepositoryMonitorStaticTests {
    ...
    func testCheckIfWorktreeRegularRepo() {
