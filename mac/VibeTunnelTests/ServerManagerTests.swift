...
final class ServerManagerTests {
    ...
    func bindAddressSetter() async throws {
        ...
        #expect(UserDefaults.standard.string(forKey: "dashboardAccessMode") == "localhost")
        #expect(manager.bindAddress == "127.0.0.1")
        
        manager.bindAddress = "0.0.0.0"
        #expect(UserDefaults.standard.string(forKey: "dashboardAccessMode") == "network")
        #expect(manager.bindAddress == "0.0.0.0")
    ...
    func bindAddressPersistence() async throws {
        ...
        UserDefaults.standard.set("localhost", forKey: "dashboardAccessMode")
        manager.port = "4021"
        ...
        UserDefaults.standard.set("network", forKey: "dashboardAccessMode")
