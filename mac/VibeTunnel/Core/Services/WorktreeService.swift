...
final class WorktreeService {
    ...
    func fetchWorktrees(for gitRepoPath: String) async {
        ...
        do {
            ...
            var components = URLComponents(url: baseURL.appendingPathComponent("api/worktrees"), resolvingAgainstBaseURL: false)!
    ...
    func createWorktree(gitRepoPath: String, branch: String, createBranch: Bool, baseBranch: String? = nil) async throws {
        guard let baseURL = URL(string: "\(URLConstants.localServerBase):\(serverManager.port)") else {
            throw WorktreeError.invalidURL
        }
    ...
    func deleteWorktree(gitRepoPath: String, branch: String, force: Bool = false) async throws {
        ...
        var components = URLComponents(url: baseURL.appendingPathComponent("api/worktrees/\(branch)"), resolvingAgainstBaseURL: false)!
    ...
    func switchBranch(gitRepoPath: String, branch: String, createBranch: Bool = false) async throws {
        ...
        var components = URLComponents(url: baseURL.appendingPathComponent("api/worktrees/switch"), resolvingAgainstBaseURL: false)!
        components.queryItems = [URLQueryItem(name: "gitRepoPath", value: gitRepoPath)]
    ...
    func toggleFollowMode(gitRepoPath: String, enabled: Bool, targetBranch: String? = nil) async throws {
        ...
        var components = URLComponents(url: baseURL.appendingPathComponent("api/worktrees/follow"), resolvingAgainstBaseURL: false)!
        components.queryItems = [URLQueryItem(name: "gitRepoPath", value: gitRepoPath)]
