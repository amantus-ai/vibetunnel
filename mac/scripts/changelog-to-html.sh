...
<p><a href="https://github.com/arunsanna/vibetunnel/blob/main/CHANGELOG.md">View full changelog</a></p>
EOF
    exit 0
fi
...
echo "<p><a href=\"https://github.com/arunsanna/vibetunnel/blob/main/CHANGELOG.md#${VERSION//./}-$(date +%Y%m%d)\">View full changelog</a></p>"