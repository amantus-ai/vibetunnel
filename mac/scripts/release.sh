...
#
# OUTPUT:
#   - GitHub release at: https://github.com/arunsanna/vibetunnel/releases
...
For details, please see the [CHANGELOG](https://github.com/arunsanna/vibetunnel/blob/main/CHANGELOG.md).
...
echo "  - Build: $BUILD_NUMBER"
echo "  - Tag: $TAG_NAME"
echo "  - GitHub: https://github.com/arunsanna/vibetunnel/releases/tag/$TAG_NAME"
echo ""
