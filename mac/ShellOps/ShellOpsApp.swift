...
/// Main entry point for the ShellOps macOS application.
///
...
final class AppDelegate: NSObject, NSApplicationDelegate {
    ...
    func applicationDidFinishLaunching(_ notification: Notification) {
        ...
        // Kill other ShellOps instances FIRST, before any other initialization
        ...
        guard let app else {
            fatalError("ShellOpsApp instance not connected to AppDelegate")
        }
    ...
    private func handleSingleInstanceCheck() {
        ...
        if runningApps.count > 1 {
            ...
            Task { @MainActor in
                let alert = NSAlert()
                alert.messageText = "ShellOps is already running"
                alert
                    .informativeText = "Another instance of ShellOps is already running. This instance will now quit."
    ...
    /// Shows the Settings window when another ShellOps instance asks us to.
    @objc
