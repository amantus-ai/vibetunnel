...
/// Centralized URL constants for the ShellOps application
enum URLConstants {
    ...
    static let website = "https://shellops.sh"
    static let githubRepo = "https://github.com/amantus-ai/shellops"
    static let githubIssues = "https://github.com/amantus-ai/shellops/issues"
    static let twitter = "https://x.com/ShellOps"
