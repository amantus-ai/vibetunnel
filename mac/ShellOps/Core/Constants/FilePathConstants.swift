...
enum FilePathConstants {
    ...
    static let applicationsShellOps = "/Applications/ShellOps.app"
    static let userApplicationsShellOps = "$HOME/Applications/ShellOps.app"
    ...
    static let shellopsBinary = "shellops"
    static let vtCLI = "vt"

    // MARK: - Configuration Files

    static let infoPlist = "Info.plist"
    static let entitlements = "ShellOps.entitlements"
