...
///
/// This struct manages user preferences for ShellOps, including
/// preferred applications for Git and terminal operations, UI preferences,
/// and update settings.
struct AppPreferences {
    /// The preferred Git GUI application.
    ///
    /// When set, ShellOps will use this application to open Git repositories.
    ...
    ///
    /// When set, ShellOps will use this terminal for opening new sessions.
    /// Common values include:
    ...
    /// Whether to show ShellOps in the macOS Dock.
    ///
