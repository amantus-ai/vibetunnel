...
final class SessionService {
    ...
    /// 2. Closes the terminal window if it was opened by ShellOps
    ///
    ...
    /// However, it only closes windows that ShellOps opened via AppleScript,
    ...
    func terminateSession(sessionId: String) async throws {
        ...
        // that ShellOps created, not externally attached sessions.
