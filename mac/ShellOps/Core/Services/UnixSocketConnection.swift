...
final class UnixSocketConnection {
    ...
    private let queue = DispatchQueue(label: "sh.shellops.unix-socket", qos: .userInitiated)
    ...
    init(socketPath: String? = nil) {
        ...
        self.socketPath = socketPath ?? "\(home)/.shellops/control.sock"
    ...
    private let sendQueue = DispatchQueue(label: "sh.shellops.unix-socket.send", qos: .userInitiated)
