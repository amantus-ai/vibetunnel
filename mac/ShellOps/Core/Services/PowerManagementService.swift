...
/// Manages system power assertions to prevent the Mac from sleeping while ShellOps is running.
///
...
final class PowerManagementService {
    ...
    func preventSleep() {
        ...
        let reason = "ShellOps is running terminal sessions" as CFString
