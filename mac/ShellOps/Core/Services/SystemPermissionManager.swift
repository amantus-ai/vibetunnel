...
extension Notification.Name {
    static let permissionsUpdated = Notification.Name("sh.shellops.permissionsUpdated")
}

/// Types of system permissions that ShellOps requires.
///
...
/// Unified manager for all system permissions required by ShellOps.
///
...
final class SystemPermissionManager {
    ...
    func showPermissionAlert(for permission: SystemPermission) {
        ...
        ShellOps needs \(permission.displayName) permission.
