...
///
/// This view guides users through granting necessary permissions for ShellOps
    ...
    var body: some View {
        VStack(spacing: 30) {
            VStack(spacing: 16) {
                ...
                Text(
                    "ShellOps needs permissions for automation to start terminal sessions and accessibility to send commands.")
                    .font(.body)
