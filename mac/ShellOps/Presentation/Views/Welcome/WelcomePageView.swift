...
/// First page of the welcome flow introducing ShellOps.
///
/// This view presents the initial onboarding screen with the app icon,
/// welcome message, and brief description of ShellOps's capabilities.
...
/// - ShellOps app icon with shadow effect
    ...
    var body: some View {
        VStack(spacing: 40) {
            ...
            VStack(spacing: 20) {
                ...
                Text(
                    "You'll be quickly guided through the basics of ShellOps.\nThis screen can always be opened from the settings.")
                    .font(.body)
                    .foregroundColor(.secondary)
                    .multilineTextAlignment(.center)
                    .frame(maxWidth: 480)
