...
///
/// This view provides information about ShellOps including version numbers,
...
struct AboutView: View {
    var appName: String {
        Bundle.main.infoDictionary?["CFBundleDisplayName"] as? String ??
            Bundle.main.infoDictionary?["CFBundleName"] as? String ?? "ShellOps"
    }
    ...
    private func openWebsite() {
        guard let url = URL(string: "https://shellops.sh") else { return }
    ...
    private var linksSection: some View {
        VStack(spacing: 10) {
            HoverableLink(url: "https://shellops.sh", title: "Website", icon: "globe")
            HoverableLink(url: "https://github.com/amantus-ai/shellops", title: "View on GitHub", icon: "link")
            HoverableLink(
                url: "https://github.com/amantus-ai/shellops/issues",
                title: "Report an Issue",
                icon: "exclamationmark.bubble")
            HoverableLink(url: "https://x.com/ShellOps", title: "Follow @ShellOps", icon: "bird")
        }
    }
