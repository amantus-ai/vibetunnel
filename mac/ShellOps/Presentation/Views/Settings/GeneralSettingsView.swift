            ...
            Form {
                ...
                Section {
                    ...
                    VStack(alignment: .leading, spacing: 4) {
                        ...
                        Text("Automatically start ShellOps when you log into your Mac.")
                            .font(.caption)
                    ...
                    VStack(alignment: .leading, spacing: 4) {
                        ...
                        VStack(alignment: .leading, spacing: 2) {
                            Text("Show ShellOps icon in the Dock.")
                                .font(.caption)
                                .foregroundStyle(.secondary)
                    ...
                    VStack(alignment: .leading, spacing: 4) {
                        ...
                        Text("Keep your Mac awake while ShellOps sessions are active.")
                            .font(.caption)
                            .foregroundStyle(.secondary)
                    }
                } header: {
