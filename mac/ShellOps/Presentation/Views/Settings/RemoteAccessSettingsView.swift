...
private struct TailscaleIntegrationSection: View {
    ...
    var body: some View {
        Section {
            ...
            Text(
                "Recommended: Tailscale provides secure, private access to your terminal sessions from any device (including phones and tablets) without exposing ShellOps to the public internet.")
                .font(.caption)
