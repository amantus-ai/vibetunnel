...
///
/// Displays the ShellOps logo, server running status, and available
...
struct ServerInfoHeader: View {
    ...
    private var appDisplayName: String {
        ...
        var name = debugMode ? "ShellOps Debug" : "ShellOps"
...
/// the ShellOps server is currently running or stopped.
