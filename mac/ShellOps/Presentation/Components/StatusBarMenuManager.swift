...
final class StatusBarMenuManager: NSObject {
    ...
    func showCustomWindow(relativeTo button: NSStatusBarButton) {
        ...
        let mainView = ShellOpsMenuView(isNewSessionActive: sessionBinding)
    ...
    func showContextMenu(for button: NSStatusBarButton, statusItem: NSStatusItem) {
        ...
        let aboutItem = NSMenuItem(title: "About ShellOps", action: #selector(showAbout), keyEquivalent: "")
        ...
        // Quit
        let quitItem = NSMenuItem(title: "Quit ShellOps", action: #selector(quitApp), keyEquivalent: "q")
    ...
    private func openWebsite() {
        if let url = URL(string: "http://shellops.sh") {
            NSWorkspace.shared.open(url)
        }
    }
    ...
    private func reportIssue() {
        if let url = URL(string: "https://github.com/amantus-ai/shellops/issues") {
            NSWorkspace.shared.open(url)
        }
    }
