...
final class ApplicationMover {
    ...
    private func offerToMoveToApplications() {
        let alert = NSAlert()
        alert.messageText = "Move ShellOps to Applications?"
        let informativeText = "ShellOps is currently running from a disk image or temporary location. " +
    ...
    private func performMoveToApplications() {
        ...
        let appName = Bundle.main.infoDictionary?["CFBundleName"] as? String ?? "ShellOps"
    ...
    private func showMoveSuccessAndRelaunch(newPath: String) {
        ...
        let informativeText = "ShellOps has been moved to Applications. " +
    ...
    private func showMoveError(_ error: Error) {
        ...
        alert.informativeText = "Could not move ShellOps to Applications: \(error.localizedDescription)"
    ...
    private func showLaunchError(_ error: Error) {
        ...
        let informativeText = "Could not launch ShellOps from Applications: \(error.localizedDescription)\n\n" +
