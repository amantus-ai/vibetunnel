...
This document outlines the migration process for moving VibeTunnel from `arunsanna/vibetunnel` to `vibetunnel/vibetunnel`.
...
# Configuration
OLD_REPO="git@github.com:arunsanna/vibetunnel.git"
...
- `https://github.com/arunsanna/vibetunnel` → `https://github.com/vibetunnel/vibetunnel`
- Git operations: `git clone git@github.com:arunsanna/vibetunnel.git` still works
- API calls to old URL redirect automatically

⚠️ **Redirect Limitations**:
- Redirects break if someone creates a new repo at `arunsanna/vibetunnel`
