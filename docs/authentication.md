...
### Key Import
- Supports unencrypted Ed25519 keys in OpenSSH or PKCS#8 PEM format
- Derives and validates the real public key before storing the private key
- Rejects encrypted, malformed, truncated, or internally inconsistent keys with a clear error
