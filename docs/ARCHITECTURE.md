...
# ShellOps Architecture

ShellOps is a modern terminal multiplexer with native macOS and iOS applications, featuring a Node.js/Bun-powered server backend and real-time web interface. The architecture prioritizes performance, security, and seamless cross-platform experience through WebSocket-based communication and native UI integration.
...
**macOS Application** - Native Swift app in mac/ShellOps/
- ServerManager (mac/ShellOps/Core/Services/ServerManager.swift) - Central server lifecycle coordinator
- BunServer (mac/ShellOps/Core/Services/BunServer.swift) - Bun runtime integration  
- BaseProcessServer (mac/ShellOps/Core/Services/BaseProcessServer.swift) - Base class for server implementations
- TTYForwardManager (mac/ShellOps/Core/Services/TTYForwardManager.swift) - Terminal forwarding logic
- SessionMonitor (mac/ShellOps/Core/Services/SessionMonitor.swift) - Active session tracking
...
**iOS Application** - Native iOS app in ios/ShellOps/
- BufferWebSocketClient (ios/ShellOps/Services/BufferWebSocketClient.swift) - WebSocket client for terminal streaming
- TerminalView (ios/ShellOps/Views/Terminal/TerminalView.swift) - Terminal rendering UI
- GhosttyWebView (ios/ShellOps/Views/Terminal/GhosttyWebView.swift) - WKWebView-based terminal renderer
...
- mac/ShellOps/Core/Protocols/ShellOpsServer.swift - Defines server interface

**Session Models**
- mac/ShellOps/Core/Models/TunnelSession.swift - Core session data structure
...
**Configuration**
- mac/ShellOps/Core/Models/AppConstants.swift - Application constants
...
1. ServerManager.start() (mac/ShellOps/Core/Services/ServerManager.swift)
...
- NgrokService (mac/ShellOps/Core/Services/NgrokService.swift) - Secure tunnel creation
