...
test.describe('Session Management', () => {
  ...
  test('should kill an active session', async ({ sessionListPage, sessionViewPage }) => {
    const sessionName = TerminalHelper.generateTestSessionName();
  ...
  test('should display session metadata correctly', async ({ sessionListPage, sessionViewPage }) => {
    const sessionName = TerminalHelper.generateTestSessionName();
  ...
  test('should handle concurrent sessions', async ({ sessionListPage, sessionViewPage, page }) => {
    const session1 = TerminalHelper.generateTestSessionName();
    const session2 = TerminalHelper.generateTestSessionName();
  ...
  test('should update session activity timestamp', async ({ sessionListPage, sessionViewPage, page }) => {
    const sessionName = TerminalHelper.generateTestSessionName();
  ...
  test('should handle session with long output', async ({ sessionListPage, sessionViewPage, page }) => {
    const sessionName = TerminalHelper.generateTestSessionName();
    ...
    await sessionViewPage.typeCommand('for i in {1..100}; do echo "Line $i: This is a test of long output handling in VibeTunnel"; done');
  ...
  test('should persist session across page refresh', async ({ sessionListPage, sessionViewPage, page }) => {
    const sessionName = TerminalHelper.generateTestSessionName();
