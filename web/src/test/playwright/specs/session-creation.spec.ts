...
test.describe('Session Creation', () => {
  ...
  test('should create a new session with default name', async ({ sessionListPage, sessionViewPage, page }) => {
  ...
  test('should create a new session with custom name', async ({ sessionListPage, sessionViewPage }) => {
  ...
  test('should show created session in session list', async ({ sessionListPage, sessionViewPage }) => {
    const sessionName = TerminalHelper.generateTestSessionName();
  ...
  test('should handle multiple session creation', async ({ sessionListPage, sessionViewPage }) => {
    const sessionNames = [
      TerminalHelper.generateTestSessionName(),
      TerminalHelper.generateTestSessionName(),
      TerminalHelper.generateTestSessionName(),
    ];
