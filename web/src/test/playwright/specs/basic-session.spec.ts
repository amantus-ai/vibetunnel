...
test.describe('Basic Session Tests', () => {
  ...
  test('should list created sessions', async ({ page }) => {
    ...
    const sessionCard = page.locator('session-card, .session-card').filter({ hasText: 'Test Session' });
  ...
  test('should navigate between sessions', async ({ page }) => {
    ...
    const sessionOne = page.locator('session-card, .session-card, [class*="session"]').filter({ hasText: 'Session One' });
    const sessionTwo = page.locator('session-card, .session-card, [class*="session"]').filter({ hasText: 'Session Two' });
