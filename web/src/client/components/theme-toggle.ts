        ...
        ${
          ...
          >
            <button
              ...
              class="w-full px-4 py-2 text-left hover:bg-bg-tertiary transition-colors flex items-center gap-3 ${this.theme === 'light' ? 'text-primary' : 'text-text'}"
            >
            ...
            <button
              ...
              class="w-full px-4 py-2 text-left hover:bg-bg-tertiary transition-colors flex items-center gap-3 ${this.theme === 'dark' ? 'text-primary' : 'text-text'}"
            >
            ...
            <button
              ...
              class="w-full px-4 py-2 text-left hover:bg-bg-tertiary transition-colors flex items-center gap-3 ${this.theme === 'system' ? 'text-primary' : 'text-text'}"
            >
