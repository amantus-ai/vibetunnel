...
describe('SessionView', () => {
  ...
  describe('toolbar actions', () => {
    ...
    // Removed test: 'should show width selector' - width selector removed in Phase 1

    // Removed test: 'should change terminal width preset' - width selector removed in Phase 1

    // Removed test: 'should pass initial dimensions to terminal' - initialCols/Rows removed in Phase 1

    // Removed test: 'should set user override when width is selected' - width selector removed in Phase 1

    // Removed test: 'should allow unlimited width selection with override' - width selector removed in Phase 1

    // Removed test: 'should show limited width label when constrained by session dimensions' - width selector removed in Phase 1

    // Removed test: 'should show unlimited label when user overrides' - width selector removed in Phase 1

    // Removed test: 'should show unlimited width for frontend-created sessions' - width selector removed in Phase 1
  });
