/**
 * Client for connecting to ShellOps Unix sockets
 */
...
/**
 * Unix socket client for communication between ShellOps web server and terminal processes.
 *
 * This class provides a robust client for connecting to Unix domain sockets with automatic
 * reconnection, heartbeat support, and message parsing using the ShellOps socket protocol.
 ...
 * const client = new ShellOpsSocketClient('/tmp/shellops/session-123.sock', {
 *   autoReconnect: true,
 ...
 */
export class ShellOpsSocketClient extends EventEmitter {
