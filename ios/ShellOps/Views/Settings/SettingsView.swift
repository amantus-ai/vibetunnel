        ...
        VStack(spacing: Theme.Spacing.xlarge) {
            ...
            VStack(spacing: Theme.Spacing.medium) {
                LinkRow(
                    icon: "globe",
                    title: "Website",
                    subtitle: "shellops.sh",
                    url: URL(string: "https://shellops.sh"))

                LinkRow(
                    icon: "doc.text",
                    title: "Documentation",
                    subtitle: "Learn how to use ShellOps",
                    url: URL(string: "https://docs.shellops.sh"))

                LinkRow(
                    icon: "exclamationmark.bubble",
                    title: "Report an Issue",
                    subtitle: "Help us improve",
                    url: URL(string: "https://github.com/shellops/shellops/issues"))

                LinkRow(
                    icon: "heart",
                    title: "Rate on App Store",
                    subtitle: "Share your feedback",
                    url: URL(string: "https://apps.apple.com/app/shellops"))
            }

            // Credits
            VStack(spacing: Theme.Spacing.small) {
                Text("Made with ❤️ by the ShellOps team")
                    .font(Theme.Typography.terminalSystem(size: 12))
                    .foregroundColor(Theme.Colors.secondaryText)
                    .multilineTextAlignment(.center)

                Text("© 2024 ShellOps. All rights reserved.")
