...
struct SessionCreateView: View {
    ...
    private func loadDefaults() {
        ...
        if let lastCommand = UserDefaults.standard.string(forKey: "shellops_last_command"), !lastCommand.isEmpty {
            self.command = lastCommand
        } else {
            // Default to zsh
            self.command = "zsh"
        }
        if let lastDir = UserDefaults.standard.string(forKey: "shellops_last_working_dir"), !lastDir.isEmpty {
    ...
    private func createSession() {
        ...
        UserDefaults.standard.set(self.command, forKey: "shellops_last_command")
        UserDefaults.standard.set(self.workingDirectory, forKey: "shellops_last_working_dir")
