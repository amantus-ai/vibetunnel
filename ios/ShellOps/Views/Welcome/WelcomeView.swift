...
///
/// Presents a multi-page onboarding experience that introduces ShellOps's features
...
struct WelcomeView: View {
    ...
    @State private var selectedTheme: TerminalTheme = .shellOps
...
/// First welcome page introducing ShellOps.
...
/// Shows how to connect to a ShellOps server from the iOS app.
...
struct GetStartedPageView: View {
    var body: some View {
        VStack(spacing: Theme.Spacing.xlarge) {
            ...
            VStack(spacing: Theme.Spacing.medium) {
                Text("Start by connecting to your ShellOps server")
                    .font(Theme.Typography.terminalSystem(size: 17))
                    .foregroundColor(Theme.Colors.secondaryText)
                    .multilineTextAlignment(.center)
