...
final class AuthenticationService: ObservableObject {
    ...
    func authenticateWithTailscale(user: String) async throws {
        ...
        self.logger.info("Tailscale identity verified for user: \(user)")
        ...
        // Mark authenticated after JWT attempt — isAuthenticated is true regardless of whether
        // the JWT was obtained, since Tailscale Serve header injection provides the primary auth.
        // API calls use Tailscale headers; only WebSocket needs the JWT (optional).
        self.isAuthenticated = true
