...
extension ServerProfile {
    ...
    static func loadAll(from userDefaults: UserDefaults = .standard) -> [ServerProfile] {
        ...
        // One-time migration: fix Tailscale profiles that had port 443 or 80 from old
        // URL-scheme derivation bug. The actual VibeTunnel server port is always 4020.
        let migrationKey = "profileMigration_tailscalePortFix"
