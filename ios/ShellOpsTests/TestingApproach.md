# ShellOps iOS Testing Approach

## Overview

The ShellOps iOS project uses a hybrid testing approach due to the separation between the Xcode project (for the app) and Swift Package Manager (for dependencies and tests).
