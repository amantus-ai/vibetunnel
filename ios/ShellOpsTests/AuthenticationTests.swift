...
struct AuthenticationTests {
    ...
    func cORSValidation() {
        ...
        let allowedOrigins: Set<String> = [
            "https://app.shellops.com",
            "https://*.shellops.com",
            "http://localhost:3000",
        ]

        #expect(isAllowedOrigin("https://app.shellops.com", allowedOrigins: allowedOrigins) == true)
        #expect(isAllowedOrigin("https://dev.shellops.com", allowedOrigins: allowedOrigins) == true)
        ...
        #expect(isAllowedOrigin("http://app.shellops.com", allowedOrigins: allowedOrigins) == false)
    }
}
