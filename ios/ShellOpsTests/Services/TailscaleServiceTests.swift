...
struct TailscaleServiceTests {
    ...
    @Test("ShellOps server detection")
    @MainActor
    func isShellOpsServerDetection() {
        ...
        #expect(macDevice.isShellOpsServer == true)
        ...
        #expect(darwinDevice.isShellOpsServer == true)
        ...
        #expect(taggedDevice.isShellOpsServer == true)
        ...
        #expect(iosDevice.isShellOpsServer == false)
    }
